...
* Для тех, кто живёт во Франции
  + в школе нет уроков, нет преподавателей, но есть много заданий, каждое их которых оценивается тремя другими студентами + для некоторых заданий компьютерная проверка
  + школа открыта 24/24
  + по окончании можно получить titre Rncp 7, который во Франции эквивалентен диплому Мастер, но действителен только 5 лет
